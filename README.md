...
## Разработка ru.javawebinar.basejava.web-приложения "База данных резюме"

В данном курсе вы создадите с нуля ru.javawebinar.basejava.web-приложение, реализуя разные способы хранения резюме. Проект включает в себя следующее:
  ...
  - **Установку (деплой) ru.javawebinar.basejava.web-приложения:**
...
#### Занятие 15
 ...
 - Настройка ru.javawebinar.basejava.web.xml
 - Деплой ru.javawebinar.basejava.web-приложения в Tomcat
 - Сервлеты
 - Домашнее задание
