...
## Разработка ru.javawebinar.web-приложения "База данных резюме"

В данном курсе вы создадите с нуля ru.javawebinar.web-приложение, реализуя разные способы хранения резюме. Проект включает в себя следующее:
  ...
  - **Установку (деплой) ru.javawebinar.web-приложения:**
...
#### Занятие 15
 ...
 - Настройка ru.javawebinar.web.xml
 - Деплой ru.javawebinar.web-приложения в Tomcat
 - Сервлеты
 - Домашнее задание
